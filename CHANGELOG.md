...
No significant changes detected since v1.5.18.
...
- [patch] Validate the ImGuiTableColumn layout before reading it ([@Claude](https://github.com/Claude))
...
No significant changes detected since v1.4.17.
...
No significant changes detected since v1.2.4-pre.14.
